...
class SpanishStopWords extends AbstractStopWords
{
    protected array $stopWords = [
        ...
        'estan','estando','estar','estaremos','estará','estarán','estarás',
