...
class GermanStopWords extends AbstractStopWords
{
    protected array $stopWords = [
        ...
        'eure','für','hatte','hatten','hattest','hattet','hier','hinter','ich',
        ...
        'nicht','nun','oder','seid','sein','seine','sich','sie','sind','soll',
        'sollen','sollst','sollt','sonst','soweit','sowie','und','unser','unsere',
        'unter','vom','von','vor','wann','warum','was','weiter','weitere','wenn',
        'wer','werde','werden','werdet','weshalb','wie','wieder','wieso','wir',
